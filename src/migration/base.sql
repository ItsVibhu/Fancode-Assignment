...
INSERT INTO mydb.news (title, description, matchId, tourId, sportId) VALUES
                                                                         ('Exciting Match Ahead!', 'Get ready for an action-packed match between Team A and Team B.', 1, 1, 1),
                                                                         ('Tour Announcement', 'Tour dates for the upcoming series between Team X and Team Y have been finalized.', NULL, 2, 1),
                                                                         ('Breaking News: Player Transfer', 'Star player XYZ transferred to Team C ahead of the upcoming season.', NULL, NULL, 2),
                                                                         ('Upcoming Tournament', 'Stay tuned for updates on the upcoming tournament featuring top teams from around the world.', NULL, NULL, 1);
...
insert ignore into mydb.matches
